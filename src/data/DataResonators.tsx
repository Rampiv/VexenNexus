...
export const DataResonators = [
  ...
  },
  {
    ...
    ConstellationDescr: [
      ...
      <>с2 - убирает нужду в большом регене энергии</>,
      <>
        с3 - экстренно захилит персонажа которого пробили ниже половины его хп
      </>,
      <>с4 - просто еще 20% хил бонуса</>,
      <>с5 - накинет еще 6 стаков электро вспышки к тем что есть</>,
      <>
        с6 - Самое важное и желанное созвездие - последняя стадия эволюции в
        ульте будет давать не +25% бонуса к умению а 50
      </>,
      <></>,
      <>
        Короче, до с6 Буллинг по сути просто затычка для новичков, для тех у
        кого Верина и Хранительница Берегов есть на аккаунте смысла от нее не
        будет, но... как только получим с6 - получим отличную замену
        Хранительнице, чуть более слабую, но все-же замену, чуть дальше покажу
        циферки
      </>,
    ],
