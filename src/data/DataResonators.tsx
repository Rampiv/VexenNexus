  ...
  },
  {
    ...
    GlossaryTerm: [
      status[5],
      {
        Термин: "Инь и Янь",
        Определение:
          "2 бафа которые нужны для активации усиленной ульты булинг, которые отображаются в форте Булинг",
        id: "InYan",
      },
    ],
    Weapon: [
    ...
    WeaponDescr: [
      ...
      <>
        3. Если вы решились таки поставить именно вариатор, то учитывайте, что
        просто так переключаться нельзя, и важно следить за печатями, в
        ...
        descr: [
          {
            text: [
              <>
                <span style={{ color: "rgb(240,128,128, 0.8)" }}>
                  Если ротация открывающая, сдайте 4 базовых атаки, главное по
                  итогу получить <GlossaryLink id="InYan">Ин и Ян</GlossaryLink>
                </span>
              </>,
              <>
                На Фроловой важно прожать умение + базовую атаку + эхо, для того
                что-б получить 2 ноты + отправить в кд кнопку Эхо, это позволит
                в следующий раз когда мы зайдем на Фролю с Интро - получится
                простой комбой набрать все ноты и выйти на хевик + ульт
              </>,
            ],
        ...
        descr: [
          {
            text: [
              ...
              "дальше, таким образом когда мы зайдем на Карлотту с интро следующее прожатие умение 1 и умение 2 - хватит на полное форте",
            ],
